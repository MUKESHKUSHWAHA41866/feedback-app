...
//       <FeedbackForm onFeedbackSubmit={() => setRefresh(!refresh)} />
...
// function App() {
//   const [refresh, setRefresh] = useState(false);
//   const [showForm, setShowForm] = useState(true); // controls which view is shown
...
//           <h1 className="text-2xl font-bold">{showForm ? 'Submit Feedback' : 'Feedback Received'}</h1>
//           <button
//             onClick={toggleView}
//             className="text-blue-600 hover:underline text-sm"
//           >
//             {showForm ? 'View Feedback' : 'Give Feedback'}
//           </button>
//         </div>
...
//             onFeedbackSubmit={() => {
//               setRefresh(!refresh);
//               setShowForm(false); // automatically go to list after submit
//             }}
//           />
//         ) : (
//           <FeedbackList key={refresh} />
